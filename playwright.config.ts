...
export default defineConfig({
    ...
    // the server is a deterministic production build. Cookie-based state
    // (tour/disclaimer) lives per context, so tests don't share it.
    ...
    reporter: process.env.CI
        ...
        : "list",
    // Generous assertion timeout: translations stream their result via SSE
